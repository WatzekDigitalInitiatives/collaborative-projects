...
//load the script for custom sorting of portfolios

function custom_sorting_js() {
    $url = get_template_directory_uri() . '-child/sorting.js';
    wp_enqueue_script( 'custom_sorting', $url);
}
add_action('wp_enqueue_scripts', 'custom_sorting_js');
