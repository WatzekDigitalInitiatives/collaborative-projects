jQuery(window).load(function() {
	...
	jQuery('.id-full .btn-container a, .ign-supportnow a').each(function(){
			...
			callbacks: {
				open: function() {
					...
					if (clickLevel != null) {
						...
						jQuery('.idc_lightbox:visible select[name="level_select"]').parent().find('.select-replace').text(jQuery('.idc_lightbox:visible select[name="level_select"] option:selected').text())
