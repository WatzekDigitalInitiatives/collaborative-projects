...
add_action( 'manage_posts_custom_column', 'display_thumbnail', 10, 1 );
...
function portfolio_init() {
	...
	$labels = array(
		'name' => __( 'Research Project', 'portfolioposttype' ),
...
function portfolio_icon() { ?>
    <style type="text/css" media="screen">
        #menu-posts-portfolio .wp-menu-image {
            background: url(<?php echo get_template_directory_uri(); ?>/images/admin/portfolio-icon.png) no-repeat 6px 4px !important;
        }
