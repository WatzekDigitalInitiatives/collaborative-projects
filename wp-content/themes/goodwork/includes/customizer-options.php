...
function rbCustomizeRegister($wp_customize){
	...
	$wp_customize->remove_section( 'static_front_page');
	 ...
	 $wp_customize->add_section('p404', array(
		'title' => '404',
		'priority' => 96
	));
	...
	$wp_customize->add_setting(
		'krown_search_layout', array(
			'default' => 'right-sidebar',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_search_layout', 
		array(
			'label' => 'Search layout',
			'section' => 'search',
			'settings' => 'krown_search_layout',
			'type' => 'select',
			'choices' => array(
	...
	$wp_customize->add_control('krown_blog_layout', 
		array(
			'label' => 'Select classic blog layout',
			'section' => 'blog',
	...
	$wp_customize->add_setting(
		'krown_modern_blog_p', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_modern_blog_p', 
		array(
			'label' => 'Modern blog page',
			'section' => 'blog',
			'settings' => 'krown_modern_blog_p',
			'type' => 'dropdown-pages',
			'priority' => 2
		)
	);
	...
	$wp_customize->add_setting(
		'krown_modern_blog_ppp', array(
			'default' => '8',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_modern_blog_ppp', 
		array(
			'label' => 'Modern blog posts number',
			'section' => 'blog',
			'settings' => 'krown_modern_blog_ppp',
			'type' => 'text',
			'priority' => 3
		)
	);
	...
	$wp_customize->add_setting(
		'krown_404_page', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_404_page', 
		array(
			'label' => 'Select default 404 page',
			'section' => 'p404',
			'settings' => 'krown_404_page',
			'type' => 'dropdown-pages'
		)
	);
	/* --- SHOP --- */
	...
	$wp_customize->add_setting(
		'krown_shop_layout', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_shop_layout', 
		array(
			'label' => 'Select the shop layout (only for product archives pages)',
			'section' => 'shop',
			'settings' => 'krown_shop_layout',
			'type' => 'select',
			'choices' => array(
				'no-sidebar' => 'No Sidebar',
				'left-sidebar' => 'Left Sidebar',
	...
	$wp_customize->add_control('rb_o_hlayout', 
		array(
			'label' => 'Header Layout',
			'section' => 'header',
			'settings' => 'rb_o_hlayout',
			'type' => 'select',
			'choices' => array(
				'f_height' => 'Full Height',
				'f_width' => 'Full Width',
				'minimal' => 'Minimal'
			)
		)
	...
	$wp_customize->add_control('rb_o_hlogo', 
		array(
			'label' => 'Logo Position',
			'section' => 'header',
			'settings' => 'rb_o_hlogo',
	...
	$wp_customize->add_control('rb_o_hsearch', 
		array(
			'label' => 'Search Box',
			'section' => 'header',
			'settings' => 'rb_o_hsearch',
			'type' => 'radio',
			'choices' => array(
				'true' => 'Show',
				'hide' => 'Hide'
	...
	$wp_customize->add_control('rb_hmenu', 
		array(
			'label' => 'Submenu Style',
			'section' => 'nav',
			'settings' => 'rb_hmenu',
	...
	$wp_customize->add_control('rb_bread', 
		array(
			'label' => 'Breadcrumbs',
			'section' => 'nav',
			'settings' => 'rb_bread',
	...
	$wp_customize->add_control('rb_ltype', 
		array(
			'label' => 'Layout Type',
			'section' => 'layout',
			'settings' => 'rb_ltype',
	...
	$wp_customize->add_control(
		'rb_o_back[boxedopacity]',
		array(
			'label' => 'Boxed Background Opacity',
			'section' => 'layout',
			'settings' => 'rb_o_back[boxedopacity]'
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Upload_Control(
			...
			'rb_o_back[pattern]',
			array(
				'label' => 'Boxed Background Pattern',
				'section' => 'layout',
				'settings' => 'rb_o_back[pattern]'
			)
		)
	);
	...
	foreach($colorsArray as $color){
		...
		$wp_customize->add_setting(
			'rb_o_colors[' . $color['setting'] . ']', array(
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				'rb_o_colors[' . $color['setting'] . ']', array(
					'label' => $color['label'],
					'section' => 'colors',
					'settings' => 'rb_o_colors[' . $color['setting'] . ']',
					'priority' => $i++
				)
			)
		);
...
add_action('customize_register', 'rbCustomizeRegister');
