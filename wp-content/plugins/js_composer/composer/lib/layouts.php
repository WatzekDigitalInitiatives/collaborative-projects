        ...
        <div class="metabox-composer-content">
				...
				<div id="visual_composer_content" class="wpb_main_sortable main_wrapper"></div>
					<div id="wpb-empty-blocks">
					 <h2>' . __("Click the '+Add element' button to add the credentials of your project collaborators!", "js_composer") .'</h2>
					 <table class="helper-block">
					   <tr>
					     <td><span>1</span></td>
					     <td><p> '. __("This is a visual preview of your page. Currently, you don't have any content elements. Click the button <a href='#' class='add-element-to-layout'><i class='icon'></i> Add element</a> on the top to add project collaborators your project page.", "js_composer") . '</p></td>
					   </tr>
					 </table>
					 <table class="helper-block">
					   <tr>
