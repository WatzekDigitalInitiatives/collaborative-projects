...
/* recommended by PINGONE, instead of "target" below */

if (!array_key_exists('RelayState', $_REQUEST)) {
	throw new SimpleSAML_Error_BadRequest('Missing Relay State parameter.');
}
...
$target = (string)$_REQUEST['RelayState'];
if (preg_match('@^https?://@i', $target)) {
	...
	$state = SimpleSAML_Auth_State::loadState($_REQUEST['RelayState'], 'saml:sp:sso');
