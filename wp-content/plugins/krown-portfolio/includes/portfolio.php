...
function portfolio_init() {
	...
	$labels = array(
		'name' => __( 'Research Projects', 'portfolioposttype' ),
		'singular_name' => __( 'Project', 'portfolioposttype' ),
		'add_new' => __( 'Add New Project', 'portfolioposttype' ),
		'add_new_item' => __( 'Add New Research Project', 'portfolioposttype' ),
		'edit_item' => __( 'Edit Research Project', 'portfolioposttype' ),
		'new_item' => __( 'Add New Research Project', 'portfolioposttype' ),
		'view_item' => __( 'View Reseearch Project', 'portfolioposttype' ),
		'search_items' => __( 'Search Research Projects', 'portfolioposttype' ),
		'not_found' => __( 'No Research Projects found', 'portfolioposttype' ),
		'not_found_in_trash' => __( 'No Research Projects found in trash', 'portfolioposttype' )
	);
	...
	$args = array(
		...
		/* original: */ //'supports' => array( 'title', 'editor', 'excerpt', 'thumbnail', 'comments', 'author', 'custom-fields', 'revisions' ),
    ...
    $taxonomy_portfolio_category_labels = array(
		'name' => _x( 'Check the Research Project Categories that describe your project (Faculty name, Research Period, Academic Department, Grant Funder, Freeform Tags) If you do not see the category you want, feel free to create your own', 'portfolioposttype' ),
		'singular_name' => _x( 'Research Project Category', 'portfolioposttype' ),
		'search_items' => _x( 'Search Research Project Categories', 'portfolioposttype' ),
		'popular_items' => _x( 'Popular Research Project Categories', 'portfolioposttype' ),
		'all_items' => _x( 'All Research Project Categories', 'portfolioposttype' ),
		'parent_item' => _x( 'Parent Research Project Category', 'portfolioposttype' ),
		'parent_item_colon' => _x( 'Parent Research Project Category:', 'portfolioposttype' ),
		'edit_item' => _x( 'Edit Research Project Category', 'portfolioposttype' ),
		'update_item' => _x( 'Update Research Project Category', 'portfolioposttype' ),
		'add_new_item' => _x( 'Add New Research Project Category', 'portfolioposttype' ),
		'new_item_name' => _x( 'New Research Project Category Name', 'portfolioposttype' ),
		'separate_items_with_commas' => _x( 'Separate research project categories with commas', 'portfolioposttype' ),
		'add_or_remove_items' => _x( 'Add or remove research project categories', 'portfolioposttype' ),
		'choose_from_most_used' => _x( 'Choose from the most used research project categories', 'portfolioposttype' ),
		'menu_name' => _x( 'Research Project Categories', 'portfolioposttype' ),
    );
/*
    $taxonomy_portfolio_category_labels = array(
